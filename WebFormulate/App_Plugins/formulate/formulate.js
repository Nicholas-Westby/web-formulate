...
directives["formDesigner/designer.html"] = "<form name=\"formulateFormDesigner\" val-form-manager>\n" +
   ...
   "                            <div class=\"formulate-field-details\">\n" +
   "                                <div class=\"control-group umb-control-group\">\n" +
   "                                    <div class=\"umb-el-wrap\">\n" +
   "                                        <label class=\"control-label\">\n" +
   ...
   "                                        </div>\n" +
   "                                    </div>\n" +
   "                                    <formulate-handler-editor directive=\"handler.directive\" configuration=\"handler.configuration\">\n" +
...
directives["viewSubmissions/viewSubmissions.html"] = "<div>\n" +
...
// Variables.
directive.$inject = ["formulateDirectives"];
controller.$inject = ["$scope", "$routeParams", "$route", "formulateTrees", "formulateForms", "$location", "dialogService", "formulateValidations", "formulateLocalization"];
var app = angular.module("umbraco");
...
// Variables.
directive.$inject = ["formulateDirectives"];
controller.$inject = ["formulateSubmissions", "dialogService", "$scope", "formulateForms"];
var app = angular.module("umbraco");
var itemsPerPage = 10;
...
},{"../Utilities/getDirective.js":84}],69:[function(require,module,exports){
// Variables.
var app = angular.module("umbraco");
...
},{"../../../FormulateTemp/directives.js":1}],85:[function(require,module,exports){
// Include all services.
require('./Services/formulateConfiguredForms.js');require('./Services/formulateDataValues.js');require('./Services/formulateDirectives.js');require('./Services/formulateEntities.js');require('./Services/formulateFields.js');require('./Services/formulateFolders.js');require('./Services/formulateForms.js');require('./Services/formulateHandlers.js');require('./Services/formulateLayouts.js');require('./Services/formulateLocalization.js');require('./Services/formulatePermissions.js');require('./Services/formulateRecursion.js');require('./Services/formulateServer.js');require('./Services/formulateSubmissions.js');require('./Services/formulateTemplates.js');require('./Services/formulateTrees.js');require('./Services/formulateValidations.js');require('./Services/formulateVars.js');
